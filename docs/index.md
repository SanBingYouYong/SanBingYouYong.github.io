...
<!-- <p style="font-size: larger;">A Natural General Intelligence model specialised in research topics ranging from <span style="font-weight: bold;">3D generation</span>, <span style="font-weight: bold;">LLM agents</span> to the broader <span style="font-style: italic;">computer graphics</span>, <span style="font-style: italic;">computer vision</span> and <span style="font-style: italic;">natural language processing</span> fields.<br>Reach out to me via <a href="mailto:rayzhang707+contact@gmail.com">rayzhang707+contact@gmail.com</a><br><small><small>Photo stylized by Nano Banana</small></small></p> -->
...
<p style="font-size: larger;">
    ...
    <span style="font-weight: bold;">3D generation</span>, 
    <span style="font-weight: bold;">LLM agents</span> to the broader 
    <span style="font-style: italic;">computer graphics</span>, 
    <span style="font-style: italic;">computer vision</span> and 
    <span style="font-style: italic;">natural language processing</span> fields.<br>
    <small>Contact: <a href="mailto:rayzhang707+ext@gmail.com">rayzhang707+ext@gmail.com</a></small>
    <br><small><small>Photo stylized by Nano Banana</small></small>
</p>

![Me at White Cliff](img/whitecliff.png)

<!-- <figure markdown="span">
  ![Me ata White Cliff](img/whitecliff.png){ width="150" }
